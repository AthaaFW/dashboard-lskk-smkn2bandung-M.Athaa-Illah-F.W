...
const TableSis = ({open}) => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            },
            {
                ...
                accessor: 'col5',
                Cell : ()=>(
                <div className='flex flex-row justify-around'><Link to="/Edit"><FaEdit className='mx-auto text-blueMain'/></Link> <BsFillTrashFill className='text-red-700'/></div>
                )
            }
        ],
        []
    ...
    return ( 
        ...
        <h1 className="text-5xl text-blueSec font-manrope">DATA SISWA</h1>
